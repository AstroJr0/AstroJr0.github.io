(function () {
  ...
  var PROJECTS = [
    ...
    {
      name     : "Matha-Lib",
      desc     : "I Was Bored And Tried To Write Simple Functions Like Integral, Factorial etc.. So I Made A Library Out Of It! Not working on it for now :)",
    ...
    {
      name     : "QsPlugin",
      desc     : "A QuickShell Project With Modularity Support For Those Who're Looking For a Module Which Isn't Available in Their Current Dotfiles :p",
      stack    : ["Python", "Bash", "QuickShell" ,"Plugin", "[UNDER CONSTRUCTION]"],
      icon     : "settings",
      link     :"https://github.com/AstroJr0/qsp",
      color    :"primary",
      colorHex : "rgba(82,242,245,0.15)"
    }
  ];
